...
const constants = {
  INSTANCE_NAME: "StaffCheckoutMap",
  mapConfig: {
    MAP_URL:
...
export interface StaffCheckoutMapProps {
  user: {
    avatar: string;
...
export const StaffCheckoutMap = React.memo((props: StaffCheckoutMapProps) => {
...
StaffCheckoutMap.displayName = `${constants.INSTANCE_NAME}`;
    ...
    >
      <div className="flex h-full w-full select-none items-center justify-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[1] flex h-full w-full items-center justify-center">
          <RippleDotA speed={2} color="#fa4d56" />
        </div>
      </div>
    </JSXMarker>
  );
